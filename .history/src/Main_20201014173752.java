...
public class Main {
    ...
    public static void playerVsPlayer(){
        ...
        for(int i = 0; i < colourFreqP1.length; ++i){
            System.out.print(colourFreqP1[i] + " ");
        }
        ...
        while(true){
            ...
            for(int i = 0; i < guessP1.length; ++i){
                if(guessP1[i] == codeP1[i]){
                    ++blacksP1;
                    --tempColourFreqP1[guessP1[i]];
                    if(blacksP1 == 4){
            ...
            for(int i = 0; i < guessP1.length; ++i){
                if(tempColourFreqP1[guessP1[i]] > 0){
                    --tempColourFreqP1[guessP1[i]];
            ...
            for(int i = 0; i < guessP2.length; ++i){
                if(tempColourFreqP2[guessP2[i]] > 0){
                    --tempColourFreqP2[guessP2[i]];
