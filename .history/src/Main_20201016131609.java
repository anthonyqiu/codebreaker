...
public class Main {
    ...
    static File leaderboards = new java.io.File("C:\\Users\\antho\\Desktop\\CodeBreaker\\src\\leaderboards.txt");

    public static void main(String[] args) {
        if(leaderboards.exists()) System.out.println("yes");
        while(true){
    ...
    public static void showLeaderBoards() throws FileNotFoundException{
    ...
    public static void updateScore(Score score) throws FileNotFoundException{
        PriorityQueue<Score> lb = new PriorityQueue<>();
        Scanner sc = new Scanner(leaderboards);
