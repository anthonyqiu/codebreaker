...
public class Main extends JFrame{
    ...
    public static void main(String[] args) throws IOException{
        File leaderboards = new java.io.File("leaderboards.txt");
    ...
    public static void showLeaderBoards(File file){
        PriorityQueue<Score> lb = new PriorityQueue<>();
        Scanner sc = new Scanner("leaderboards.txt");
    ...
    public static void updateScore(File file, Score score){
        PriorityQueue<Score> lb = new PriorityQueue<>();
        Scanner sc = new Scanner("leaderboards.txt");
