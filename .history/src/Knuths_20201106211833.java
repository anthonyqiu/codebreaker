...
*/
    public static void AIGuessKnuths(){
        ...
        while(true){    //every loop is one turn for the ai
            ...
            if(candidates.size() == 1) guess = candidates.get(0);   //if there is one code left that is the correct answer, thus guess it
